...
Nach der Erstellung des PDF-Dokument muss es weiter an den Client geschickt werden. Um das PDF-Dokumente im \textit{Response} zu übertragen, wird das Dokument in ein \textit{byte-array} konvertiert. Dies geschieht mit der Verwendung des \textit{ByteArrayOutputStream} und dessen Methode \textit{toByteArray}. 
